var CarbonComponents = (function (exports) {
	...
	var DataTable = /*#__PURE__*/function (_mixin) {
	  ...
	  function DataTable(_element, options) {
	    ...
	    //   }
	    // }); BUG: !UNOFFICIAL MODIFICATION! this event handler repeatedly throws errors on all text fields within a DataTable presumably due to the missing option selectorToolbarSeatchContainer that's never initalized on watch or direct create call per testing. We aren't using CDS' builtin search functionality (partially due to the shit documentation not showing how to) and theres no chance of this getting fixed since its v10 and last release for vanillaJS so this is commented out.
